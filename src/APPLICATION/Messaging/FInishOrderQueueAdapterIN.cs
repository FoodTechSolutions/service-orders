...
public class FinishOrderQueueAdapterIN : BackgroundService
{
    private IConnection _connection;
    private IModel _channel;
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<FinishOrderQueueAdapterIN> _logger;
    private string RABBIT_HOST;
    private string RABBIT_PORT;
    private string RABBIT_USERNAME;
    private string RABBIT_PASSWORD;

    public FinishOrderQueueAdapterIN(IServiceProvider serviceProvider,
        ILogger<FinishOrderQueueAdapterIN> logger,
    ...
    public async Task Consumer(object sender, BasicDeliverEventArgs e)
    {
        using (var scope = _serviceProvider.CreateScope())
        {
            ...
            var command = new NextStepOrderCommand(order.OrderId, DOMAIN.Enums.OrderStatus.Finished);
